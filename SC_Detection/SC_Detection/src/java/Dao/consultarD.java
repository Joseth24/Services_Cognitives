...
public class consultarD {
    ...
    public consultarM consultar(String url) throws IOException {
        ...
        try {
            ...
            HttpPost request = new HttpPost("https://brazilsouth.api.cognitive.microsoft.com/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=false&recognitionModel=recognition_01&returnRecognitionModel=false&returnFaceAttributes=age,gender,smile,facialHair,glasses,emotion,hair,makeup,occlusion,accessories");
